...
8-ft Weyerhaeuser 2.0E Microllam LVL residential header case (Option~2: exact
solution comparison) — $E=2{,}000{,}000$~psi per ESR-1387, $b=3.5$~in,
$d=11.25$~in, $L=96$~in, $q_0=500$~lb/ft.
The governing equation and spatial discretization are identical to those documented in HW\,2.
...
\[
  ...
  M_{\max}^{\mathrm{exact}} = 48{,}000.00\;\text{lb}\cdot\text{in},\quad
...
\begin{tabular}{lrrrr}
  ...
  \midrule
  $w_{\max}$ [in]          & 0.0554802 & 0.0559241 & 0.0554819 & 0.0031\% \\
...
\begin{tabular}{rccccc}
  ...
  \midrule
  10  & 9.600 & $1.59\times10^{3}$ & $3.53\times10^{-13}$ & $1.96\times10^{-14}$ & $4.44\times10^{-4}$ \\
  20  & 4.800 & $2.61\times10^{4}$ & $5.79\times10^{-12}$ & $3.21\times10^{-13}$ & $1.11\times10^{-4}$ \\
  40  & 2.400 & $4.20\times10^{5}$ & $9.32\times10^{-11}$ & $5.17\times10^{-12}$ & $2.77\times10^{-5}$ \\
  80  & 1.200 & $6.72\times10^{6}$ & $1.49\times10^{-9}$  & $8.28\times10^{-11}$ & $6.94\times10^{-6}$ \\
  160 & 0.600 & $1.08\times10^{8}$ & $2.39\times10^{-8}$  & $1.33\times10^{-9}$  & $1.73\times10^{-6}$ \\
  \bottomrule
\end{tabular}
\end{table}
