...
\begin{tabular}{ccc}
  ...
  \midrule
  $E = \muE - \sigE$ & 1,440,000 & $\beta = 0.0772100$  (larger, $\alpha$ = max SRQ) \\
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{../hw5_figures/fig1_datasets.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{../hw5_figures/fig2_cdf_dataset1.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{../hw5_figures/fig3_cdf_dataset2.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{../hw5_figures/fig4_avm_mavm_bar.pdf}
